...
text(Scores_PCA_leaves,labels=c("Leaves_P1","Leaves_P2","Leaves_P3","Leaves_P4","Leaves_P5","Leaves_P6"), cex= 0.7, pos=1)
...
text(Scores_PCA_roots,labels=c("Roots_P1","Roots_P2","Roots_P3","Roots_P4","Roots_P5","Roots_P6"), cex= 0.7, pos=1)
